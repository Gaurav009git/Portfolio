    ...
    <>
      ...
      <style>{`
        ...
        * {
        ...
        /* Override for floating mobile nav */
        .mobile-nav {
          position: fixed;
        ...
        /* Override for floating mobile nav items */
        ...
        /* Override for floating nav icons */
        ...
        .mobile-nav .mobile-nav-item.active .mobile-nav-icon {
          filter: grayscale(0) brightness(1.2) !important;
          transform: scale(1.15) !important;
        }

        .mobile-nav .mobile-nav-item:hover .mobile-nav-icon {
          filter: grayscale(0.4) brightness(1.1) !important;
